...
<table>
  ...
  <tr>
    <td><img src="../assets/destinations/providencia/reef.jpg" width="100%"></td>
...
<script>
  var map = L.map('map').setView([13.35, -81.37], 13);
  L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '© OpenStreetMap'
  }).addTo(map);

  var points = [
    [13.359, -81.363], // 1. El Pico
    [13.385, -81.353], // 2. Cayo Cangrejo
    [13.388, -81.373], // 3. Santa Catalina
    [13.333, -81.383], // 4. Southwest Bay (Buceo)
    [13.355, -81.355]  // 5. Aeropuerto El Embrujo
  ];
  ...
  createLabel(1, points[0]).addTo(map).bindPopup('1. El Pico (Trekking)');
  createLabel(2, points[1]).addTo(map).bindPopup('2. Cayo Cangrejo (Snorkel)');
  createLabel(3, points[2]).addTo(map).bindPopup('3. Santa Catalina (Cuevas)');
  createLabel(4, points[3]).addTo(map).bindPopup('4. Southwest Bay (Buceo Técnico)');
